...
- Pages updated: [[wiki/concepts/abap-naming-conventions]], [[wiki/concepts/clean-abap]], [[wiki/concepts/mvc-in-abap]], [[wiki/topics/abap-quality-gates]], [[wiki/topics/abap-performance]], [[wiki/snippets/flower-box-header]], [[index.md]]
...
- Pages updated: [[wiki/concepts/sap-fiori-overview]] (stub → draft), [[wiki/concepts/odata-service]] (stub → draft, +contradiction callout), [[wiki/entities/tools/segw]] (stub → draft), [[index.md]]
